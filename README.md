...
4. Просто напиши Клоду, например:
   ...
   Чтобы браузер **не всплывал** во время работы — добавь «в фоновом (headless) режиме» к просьбе,
   или запусти сканер с `HEADLESS=1` (см. ниже). По умолчанию — headed (так пробивается больше антибота).
...
# фоном, без всплывающего браузера:
